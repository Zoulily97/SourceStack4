    ...
    public class Program
    {
       ...
       public static int F(int[] a1, int start, int end)
            ...
            static void Main(string[] args)
        {
            ...
            Console.WriteLine(FindGreatestSumOfSubArray(arr));
            Console.WriteLine(FindMAxArraySum(arr));
        ...
        static string CovDate(int second)
        {
            TimeSpan s = new TimeSpan(0, 0, second);
            string date = s.Hours.ToString() + "小时" + s.Minutes.ToString() + "分" + s.Seconds.ToString() + "秒";
            return date;
        }
        ...
        static int FindMAxArraySum( int[] array)
        {
            int a = 0;
            int Max = array[0];
            for (int i = 0; i < array.Length; i++)
